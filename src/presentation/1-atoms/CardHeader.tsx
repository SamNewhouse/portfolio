      ...
      <div className={`p-4${cardHeaderClassName ? " " + cardHeaderClassName : ""}`}>
        <div className="overflow-hidden rounded-xl">
          <img
              ...
              height="310"
              alt={cardName}
              className="mx-auto aspect-video object-cover object-center brightness-75 saturate-150 hover:scale-[107%] hover:saturate-100 hover:brightness-[90%] transition-all duration-300"
          />
          </div>
        </div>
    </>
